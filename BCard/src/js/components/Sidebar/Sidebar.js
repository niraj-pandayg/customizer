        ...
        <div class="sidebar-menu">
          <div class="menu-icons">
            <section id="sidebar"> 
              <ul>
              <li>
                  <div onClick={this.updateState.bind(this)} data-type="template" class="full-width">
                    <a class="icon icon-theme" style={spriteBackground} data-type="template"></a>
                    <a data-type="template">Template</a>
                  </div>
                </li>
                <li>
                ...
                <li>
                  <div onClick={this.updateState.bind(this)} data-type="shape" class="full-width">
                    <a class="icon icon-elements" style={spriteBackground} data-type="shape"></a>
                    <a data-type="shape">Shapes</a>
                  </div>
                </li>
              </ul>
            </section>
