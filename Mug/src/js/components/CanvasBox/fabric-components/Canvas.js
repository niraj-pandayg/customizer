...
class Fabric_Canvas{
	constructor(object){
		this.width = (object && typeof object.width != "undefined") ? object.width : 530;
		this.height = (object && typeof object.height != "undefined") ? object.height : 530;
		this.id = (object && typeof object.id != "undefined") ? object.id :'canvas';
		this.canvas = null;
		this.backgroundColor = (object && typeof object.backgroundColor != "undefined") ? object.backgroundColor :'#f3f3f3';
	}
	init(){
		var that = this;
		...
		FabricStore.setCanvasFront(this.canvas);
		FabricStore.setCanvasBack(this.canvas);
		FabricStore.setEmptyCanvas(this.canvas);
      	this.canvas.on('object:selected',function(object){
      		FabricStore.setActiveObject(object.target);
      	});
